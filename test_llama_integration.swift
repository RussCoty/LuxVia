...
print("")
print("   State: collectingTraits")
print("   → 'Ask about their personality traits or what made them special.'")
print("")
print("   State: collectingStories")
print("   → 'Ask for a specific memory or story that captures who they were.'")
